...
function StackDoodle({ size = 20, className = "" }: { size?: number; className?: string }) {
  return (
...
export function BlockGroupCard({
  ...
  const totalProgress =
    childBlocks.length > 0
      ? Math.round(childBlocks.reduce((s, b) => s + b.progress, 0) / childBlocks.length)
      : 0
      ...
      >
        ...
        <div className="flex items-center gap-1.5 mb-2 opacity-80">
          ...
          <span
            ...
            style={{ backgroundColor: "rgba(255,255,255,0.2)", borderRadius: "2px 5px 3px 6px" }}
          >
        ...
        {childBlocks.length > 0 ? (
          <div
            ...
            style={{
              gridTemplateColumns: childBlocks.length <= 2 ? "repeat(2, 1fr)" : "repeat(3, 1fr)",
        ...
        <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/20">
          <span className="text-sm font-serif opacity-70">
            {completedCount}{" / "}{childBlocks.length}{" completed"}
          </span>
